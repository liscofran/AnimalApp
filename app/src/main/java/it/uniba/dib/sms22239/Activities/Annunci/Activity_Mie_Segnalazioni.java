...
public class Activity_Mie_Segnalazioni extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aggiungiSegnalazione.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Activity_Mie_Segnalazioni.this, Activity_Registrazione_Segnalazione.class);
    ...
    protected void onStart() {
        ...
        mainAdapterSegnalazione = new FirebaseRecyclerAdapterSegnalazione(options, new FirebaseRecyclerAdapterSegnalazione.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent = new Intent(Activity_Mie_Segnalazioni.this, Activity_Profilo_Segnalazione.class);
