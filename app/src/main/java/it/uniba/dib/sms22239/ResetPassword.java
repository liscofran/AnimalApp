    ...
    private void recoverPassword()
    {
        ...
        firebaseAuth.sendPasswordResetEmail(email).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                ...
                Toast.makeText(ResetPassword.this, "Istruzioni per il reset della password inviati a " + email, Toast.LENGTH_SHORT).show();
                Toast.makeText(ResetPassword.this,"Password cambiata con successo a " + email,Toast.LENGTH_LONG).show();
            ...
            public void onFailure(@NonNull Exception e) {
                //invio fallito
                progressDialog.dismiss();
                Toast.makeText(ResetPassword.this,"Invio delle istruzioni fallito" + e.getMessage(),Toast.LENGTH_SHORT).show();
            }
        });
    }
}
