...
import it.uniba.dib.sms22239.Fragments.Fragment_Prenotazione_Selezionata;
import it.uniba.dib.sms22239.Models.Prenotazione;
import it.uniba.dib.sms22239.R;

public class Activity_Calendario_Prenotazioni_Veterinario extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.home).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Activity_Calendario_Prenotazioni_Veterinario.this, Activity_Home.class);
        ...
        findViewById(R.id.profile).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Activity_Calendario_Prenotazioni_Veterinario.this, Activity_Profilo_Proprietario.class));
            }
        });
        ...
        findViewById(R.id.annunci).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Activity_Calendario_Prenotazioni_Veterinario.this, Activity_Menu_Annunci.class));
            }
        });
        ...
        findViewById(R.id.qr).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Activity_Calendario_Prenotazioni_Veterinario.this, Activity_QRcode.class));
            }
        });
        ...
        findViewById(R.id.impostazioni).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Activity_Calendario_Prenotazioni_Veterinario.this, Activity_Settings.class));
            }
        });
        findViewById(R.id.scheda).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Activity_Calendario_Prenotazioni_Veterinario.this, Activity_Scheda_Veterinario.class));
            }
        });
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Activity_Calendario_Prenotazioni_Veterinario.this, "Fail to get data.", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        calendarView.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            ...
            public void onSelectedDayChange(CalendarView view, int year, int month, int dayOfMonth) {
                ...
                Fragment_Prenotazione_Selezionata dialog = new Fragment_Prenotazione_Selezionata(prenotazioni, data, idAnimale);
