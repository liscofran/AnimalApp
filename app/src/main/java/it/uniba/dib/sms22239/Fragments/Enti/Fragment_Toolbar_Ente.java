...
import it.uniba.dib.sms22239.Activities.Enti.Activity_Ente;
...
public class Fragment_Toolbar_Ente extends Fragment {
    public Fragment_Toolbar_Ente() {
    }

    public static Fragment_Toolbar_Ente newInstance(String param1, String param2) {
        Fragment_Toolbar_Ente fragment = new Fragment_Toolbar_Ente();
        return fragment;
    }
    ...
    public void onViewCreated (View view, Bundle savedInstanceState){
        ...
        view.findViewById(R.id.profile).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getActivity(), Activity_Ente.class));
            }
        });
