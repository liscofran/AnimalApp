...
public class Activity_Mie_Offerte extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aggiungiOfferte.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Activity_Mie_Offerte.this, Activity_Registrazione_Offerte.class);
                startActivity(intent);
            }
        });
    ...
    protected void onStart() {
        ...
        mainAdapterOfferte = new FirebaseRecyclerAdapterOfferte(options, new FirebaseRecyclerAdapterOfferte.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Intent intent = new Intent(Activity_Mie_Offerte.this, Activity_Profilo_Offerta.class);
