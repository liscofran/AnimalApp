...
public class Activity_Animale_Selezionato_Album extends AppCompatActivity {
    ...
    private void mysearch(String str)
    {
        ...
        RecyclerAdapterAnimale adapter = new RecyclerAdapterAnimale(filteredList, new RecyclerAdapterAnimale.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                Spinner spinner = new Spinner(Activity_Animale_Selezionato_Album.this);
                ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(Activity_Animale_Selezionato_Album.this, R.array.relazione_options, android.R.layout.simple_spinner_item);
                adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                spinner.setAdapter(adapter);
                // creazione dell'AlertDialog con lo spinner
                new AlertDialog.Builder(Activity_Animale_Selezionato_Album.this)
                        .setTitle(c1)
                        .setMessage(c2)
                        .setView(spinner)
                        .setPositiveButton(c3, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(Activity_Animale_Selezionato_Album.this, c4 + " " + selectedOption + " " + c5, Toast.LENGTH_SHORT).show();
                                ...
                                Intent intent = new Intent(Activity_Animale_Selezionato_Album.this, Activity_Profilo_Animale.class);
