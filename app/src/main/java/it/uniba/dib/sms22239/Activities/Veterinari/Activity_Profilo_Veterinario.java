...
import it.uniba.dib.sms22239.Fragments.Veterinari.Fragment_Profile_Veterinario;
...
public class Activity_Profilo_Veterinario extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        findViewById(R.id.annunci).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Activity_Profilo_Veterinario.this, Activity_Menu_Annunci.class));
            }
        });
