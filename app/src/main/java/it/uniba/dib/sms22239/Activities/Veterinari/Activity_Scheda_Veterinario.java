    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appuntamenti.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Activity_Scheda_Veterinario.this, Activity_Calendario_Appuntamenti_Veterinario.class);
        ...
        prenotazioni.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Activity_Scheda_Veterinario.this, Activity_Calendario_Prenotazioni_Veterinario.class);
                startActivity(intent);
            }
        });
        ...
        findViewById(R.id.annunci).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Activity_Scheda_Veterinario.this, Activity_Menu_Annunci.class));
            }
        });
