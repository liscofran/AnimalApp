...
public class RecyclerAdapterSegnalazione extends RecyclerView.Adapter<RecyclerAdapterSegnalazione.ViewHolder> {

    private List<Segnalazione> filteredList;

    public RecyclerAdapterSegnalazione(List<Segnalazione> filteredList, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.bind(segnalazione, position);
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Segnalazione segnalazione, int position) {
            name.setText(segnalazione.oggetto);
            oggetto.setText(segnalazione.descrizione);

            StorageReference mStorageRef = FirebaseStorage.getInstance().getReference();
            StorageReference imageRef = mStorageRef.child("Segnalazioni/" + segnalazione.idSegnalazione + ".jpg");
