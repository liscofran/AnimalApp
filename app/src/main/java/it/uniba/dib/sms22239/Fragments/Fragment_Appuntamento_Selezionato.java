...
import it.uniba.dib.sms22239.Activities.Veterinari.Activity_Appuntamento_Veterinario_Animale;
import it.uniba.dib.sms22239.Models.Appuntamento;
import it.uniba.dib.sms22239.R;

public class Fragment_Appuntamento_Selezionato extends DialogFragment {
    private ArrayList<Appuntamento> appuntamenti;
    private String data;
    private String idAnimale;

    public Fragment_Appuntamento_Selezionato(ArrayList<Appuntamento> appuntamenti, String data, String idAnimale) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (appuntamentoSelezionato != null) {
                    ...
                    Intent intent = new Intent(getActivity(), Activity_Appuntamento_Veterinario_Animale.class);
