...
import it.uniba.dib.sms22239.Activities.Animali.Activity_Prenotazioni_Appuntamenti_Animale;
import it.uniba.dib.sms22239.Activities.Animali.Activity_QRGenerate;
import it.uniba.dib.sms22239.Activities.Animali.Activity_Spese;
...
public class Fragment_Profilo_Animale extends Fragment {
    ...
    public Fragment_Profilo_Animale() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        appre.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), Activity_Prenotazioni_Appuntamenti_Animale.class);
        ...
        getView().findViewById(R.id.modifica).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                fragmentTransaction.replace(R.id.fragment_container, new Fragment_Edit_Profilo_Animale());
