...
public class Activity_PrenotazioniAppuntamenti_Utente extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.home).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Activity_PrenotazioniAppuntamenti_Utente.this, Activity_Home.class);
                startActivity(intent);
            }
        });
        ...
        findViewById(R.id.profile).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Activity_PrenotazioniAppuntamenti_Utente.this, Activity_Profilo_Veterinario.class));
            }
        });
        ...
        findViewById(R.id.annunci).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Activity_PrenotazioniAppuntamenti_Utente.this, Activity_Segnalazioni_Offerte.class));
            }
        });
        ...
        findViewById(R.id.qr).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Activity_PrenotazioniAppuntamenti_Utente.this, Activity_QRcode.class));
            }
        });
        ...
        findViewById(R.id.pet).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Activity_PrenotazioniAppuntamenti_Utente.this, Activity_Animali.class));
            }
        });
        ...
        findViewById(R.id.impostazioni).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Activity_PrenotazioniAppuntamenti_Utente.this, Preference.class));
            }
        });
