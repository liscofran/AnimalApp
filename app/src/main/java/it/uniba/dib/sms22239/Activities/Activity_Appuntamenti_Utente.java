...
public class Activity_Appuntamenti_Utente extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_appuntamenti_utente);
            ...
            findViewById(R.id.home).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(Activity_Appuntamenti_Utente.this, Activity_Home.class);
            ...
            findViewById(R.id.annunci).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    startActivity(new Intent(Activity_Appuntamenti_Utente.this, Activity_Segnalazioni_Offerte.class));
                }
            });
            ...
            findViewById(R.id.qr).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    startActivity(new Intent(Activity_Appuntamenti_Utente.this, Activity_QRcode.class));
                }
            });
            ...
            findViewById(R.id.impostazioni).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    startActivity(new Intent(Activity_Appuntamenti_Utente.this, Preference.class));
                }
            });
            findViewById(R.id.pet).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    startActivity(new Intent(Activity_Appuntamenti_Utente.this, Activity_Animali.class));
                }
            });
            ...
            mDatabase.addValueEventListener(new ValueEventListener() {
               ...
               /* for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    Toast.makeText(Activity_Appuntamenti_Utente.this, "Fail to get data.", Toast.LENGTH_SHORT).show();
                }
