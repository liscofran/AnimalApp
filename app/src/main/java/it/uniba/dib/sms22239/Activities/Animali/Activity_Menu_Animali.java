...
public class Activity_Menu_Animali extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        crea_animale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Activity_Menu_Animali.this, Activity_Registrazione_Animale.class);
        ...
        miei_animali.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Activity_Menu_Animali.this, Activity_Miei_Animali.class);
                startActivity(intent);
            }
        });
        ...
        album_animali.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                Intent intent = new Intent(Activity_Menu_Animali.this, Activity_Album_Animali.class);
                startActivity(intent);
            }
        });
        ...
        cerca_animali.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                Intent intent = new Intent(Activity_Menu_Animali.this, Activity_Ricerca_Animali.class);
                startActivity(intent);
            }
        });
    }
