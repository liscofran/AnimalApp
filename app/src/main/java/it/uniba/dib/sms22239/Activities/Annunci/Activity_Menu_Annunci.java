...
public class Activity_Menu_Annunci extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        creasegnalazione.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Activity_Menu_Annunci.this, Activity_Registrazione_Segnalazione.class);
        ...
        creaofferta.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Activity_Menu_Annunci.this, Activity_Registrazione_Offerte.class);
                startActivity(intent);
            }
        });
        ...
        mieofferte.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Activity_Menu_Annunci.this, Activity_Mie_Offerte.class);
                startActivity(intent);
            }
        });
        ...
        ricercasegnalazione.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Activity_Menu_Annunci.this, Activity_Ricerca_Segnalazioni.class);
                startActivity(intent);
            }
        });
        ...
        miesegnalazioni.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Activity_Menu_Annunci.this, Activity_Mie_Segnalazioni.class);
                startActivity(intent);
            }
        });
        ...
        ricercaofferta.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Activity_Menu_Annunci.this, Activity_Ricerca_Offerte.class);
                startActivity(intent);
            }
        });
