    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.home).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Activity_Bluetooth.this, Activity_Home.class);
        ...
        findViewById(R.id.profile).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Activity_Bluetooth.this, Activity_Profile_Proprietario_Ente.class));
            }
        });
        ...
        findViewById(R.id.annunci).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Activity_Bluetooth.this, Activity_Segnalazioni_Offerte.class));
            }
        });
        ...
        findViewById(R.id.pet).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Activity_Bluetooth.this, Activity_Animali.class));
            }
        });
        ...
        findViewById(R.id.qr).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Activity_Bluetooth.this, Activity_QRcode.class));
            }
        });
        ...
        findViewById(R.id.impostazioni).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Activity_Bluetooth.this, Preference.class));
            }
        });
        ...
        mButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Toast.makeText(Activity_Bluetooth.this, "Errore durante l'invio dei dati al dispositivo Bluetooth", Toast.LENGTH_SHORT).show();
                }
            }
        });
            ...
            public void run() {
                ...
                while (!stopWorker) {
                    try {
                        ...
                        Toast.makeText(Activity_Bluetooth.this, "Errore durante la ricezione dei dati dal dispositivo Bluetooth", Toast.LENGTH_SHORT).show();
                        stopWorker = true;
                    }
                }
            }
