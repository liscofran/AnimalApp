...
import it.uniba.dib.sms22239.Activities.Veterinari.Activity_Prenotazione_Veterinario;
import it.uniba.dib.sms22239.Activities.Animali.Activity_Prenotazione_Animale;
import it.uniba.dib.sms22239.Models.Prenotazione;

public class Fragment_Prenotazione_Selezionata extends DialogFragment {
    private ArrayList<Prenotazione> prenotazioni;
    private String data;
    private String idAnimale;

    public Fragment_Prenotazione_Selezionata(ArrayList<Prenotazione> prenotazioni, String data, String idAnimale) {
        this.prenotazioni = prenotazioni;
        this.data = data;
        this.idAnimale = idAnimale;
    }

    public Fragment_Prenotazione_Selezionata() {
    }
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (finalPrenotazioneSelezionata != null) {
                            ...
                            if (userClass != null && userClass.equals("Veterinario")) {
                                intent = new Intent(getActivity(), Activity_Prenotazione_Veterinario.class);
