...
public class Fragment_toolbarEnte extends Fragment {
    public Fragment_toolbarEnte() {
    }

    public static Fragment_toolbarEnte newInstance(String param1, String param2) {
        Fragment_toolbarEnte fragment = new Fragment_toolbarEnte();
        return fragment;
    }
